...
TEST(esEncuestaValidaTEST, invalidaColumnasIndividuos) {
    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2}};
    eph_i ti = {{22114},
                {22114}};
...
TEST(esEncuestaValidaTEST, hayHogaresSinIndividuos) {
    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2},
                {20957, 2020, 3, 313965, 623297, 1, 43, 0, 1, 3, 1, 2}};
    eph_i ti = {{20957, 2020, 1, 1, 3, 1, 88, 0, 0, 90000, 10},
                {20957, 2020, 2, 1, 3, 2, 82, 0, 0, 25000, 10}};
...
TEST(esEncuestaValidaTEST, invalidaDistintoAnioEntreIndividuos) {
    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2},
                {22866, 2020, 3, 317157, 627217, 2, 42, 1, 1, 2, 2, 2},
                {20957, 2020, 3, 313965, 623297, 1, 43, 0, 1, 3, 1, 2}};
    eph_i ti = {{20957, 2020, 1, 1, 3, 1, 88, 0, 0, 90000, 10},
                ...
                {22866, 2020, 1, 0, 3, 1, 31, 1, 3, 59000, 10},
                {22866, 2020, 2, 1, 3, 2, 28, 1, 3, 0,     6},
                {22114, 2021, 1, 0, 3, 1, 18, 0, 0, 20000, 10}};
...
TEST(esEncuestaValidaTEST, invalidaDormitoriosMayoresAHabitacionesOK) {
    //                                                cantidad de dormitorios
    //                                        cantidad de habitaciones  |
    //                                                              |   |
    //                                                              v   v
    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2},
                {22866, 2020, 3, 317157, 627217, 2, 42, 1, 1, 2, 8, 2},
                {20957, 2020, 3, 313965, 623297, 1, 43, 0, 1, 3, 1, 2}};
    eph_i ti = {{20957, 2020, 1, 1, 3, 1, 88, 0, 0, 90000, 10},
                {20957, 2020, 2, 2, 3, 2, 82, 0, 0, 25000, 10},
                {22866, 2020, 1, 0, 3, 1, 31, 1, 3, 59000, 10},
                {22866, 2020, 2, 1, 3, 2, 28, 1, 3, 0,     6},
                {22114, 2020, 1, 0, 3, 1, 18, 0, 0, 20000, 10}};
...
TEST(esEncuestaValidaTEST, invalidaMenosOIgualA20MiembrosEnElHogar) {
    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2}};
    eph_i ti;
...
TEST(esEncuestaValidaTEST, invalidaValoresEnRangoHogares) {

    eph_h th = {{22114, 2020, 3, 319611, 629088, 3, 41, 0, 1, 3, 1, 2},
                {31117, 2020, 3, 332870, 642475, 3, 40, 0, 1, 6, 6, 2},
                {22866, 2020, 3, 317157, 627217, 2, 42, 1, 8, 2, 2, 2},
                {20957, 2020, 3, 313965, 623297, 1, 43, 0, 1, 3, 1, 2}};
