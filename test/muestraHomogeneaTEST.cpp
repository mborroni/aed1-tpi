...
TEST(muestraHomogeneaTEST, variasDe3UnaLarga) {
    vector <hogar> res = {{543,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {340,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
                          {1009, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {1,    2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {4377, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {800,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {200,  2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
                          {760,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
                          {660,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
                          {460,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1}
    };
    eph_h th = {
            {340,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
            {1009, 2018, 1, 1, 2, 1, 1, 1, 1, 2,1,1},
            ...
            {760,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
            {660,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
            {560,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1},
            {460,  2018, 1, 1, 1, 1, 1, 1, 1, 2,1,1}
    };

    eph_i ti = {{543,  2018, 1, 1, 1, 1, 36, 1,  3, 1, 1}, // 1
                {334,  2018, 2, 1, 1, 1, 36, 1,  3, 2, 1}, // 2
                {340,  2018, 1, 1, 1, 1, 36, 1,  3, 3, 1}, // 3
                {340,  2018, 3, 1, 1, 1, 36, 1,  3, -1, 1},
                {1009, 2018, 1, 1, 1, 1, 36, 1,  3, 5, 1}, // 5
                {210,  2018, 1, 1, 1, 1, 36, 1,  3, 6, 1}, // 6
                {210,  2018, 2, 1, 1, 1, 36, 1,  3, 0, 1},
                {1,    2018, 1, 1, 1, 1, 36, 1,  3, 7, 1}, // 7
                {4377, 2018, 1, 1, 1, 1, 36, 1,  3, 9, 1}, // 9
                {4377, 2018, 3, 1, 1, 1, 36, 1,  3, 0, 1},
                {2354, 2018, 1, 1, 1, 1, 36, 1,  3, 10, 1}, // 10
                {800,  2018, 2, 1, 1, 1, 36, 1,  3, 11, 1}, // 11
                {200,  2018, 2, 1, 1, 1, 36, 1,  3, 13, 1},
                {960,  2018, 3, 1, 1, 2, 51, 1,  4, 14,  1},
                {960,  2018, 2, 1, 1, 2, 51, 1,  4, 0,  1},
                {960,  2018, 1, 1, 1, 2, 51, 1,  4, 0,  1},
                {760,  2018, 1, 1, 1, 2, 51, 1,  4, 15,  1},
                {660,  2018, 1, 1, 1, 2, 51, 1,  4, 17,  1},
                {560,  2018, 1, 1, 1, 2, 51, 1,  4, 18,  1},
                {460,  2018, 1, 1, 1, 2, 51, 1,  4, 19,  1}};
