...
TEST(creceElTeleworkingEnCiudadesGrandesTEST, todosDesocupados) {
...
//                                                                   v
    eph_i t1i = {{20957, 2018,   1,  1,  3,  1,  88, 0,  0,  90000,  1},
                 {20957, 2018,   2,  1,  3,  2,  82, 0,  0,  25000,  1},
                 {22866, 2018,   1,  0,  3,  1,  31, 0,  3,  59000,  1},
                 {22866, 2018,   2,  1,  3,  2,  28, 0,  3,  0,      6}, // Esta no: Hotel
...
//                                                           v   v           v
    ...
    eph_i t2i = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  1},
                 {20957, 2020,   2,  1,  3,  2,  82, 0,  0,  25000,  1},
                 {22866, 2020,   1,  0,  3,  1,  31, 0,  3,  59000,  1},
                 {22866, 2020,   2,  1,  3,  2,  28, 0,  3,  0,      6}, // Esta no: Hotel
                 {31117, 2020,   3,  0,  3,  2,  46, 0,  3,  17000,  1},
                 {31117, 2020,   4,  0,  3,  1,  20, 0,  3,  5000,   6},
                 {31117, 2020,   5,  0,  3,  2,  15, 0,  0,  5000,   6},
                 {22114, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  1}};
